    ...
    *************************************************************************************
    ...
    Retorna:
        ...
        *********************************************************************************
        ...
        Returns:
        pd.DataFrame: DataFrame containing the header information, where the header keys 
            are the index, and the values are stored in a column named "value".
        """
    ...
    def __getitem__(self, k: str):
        """
         Descripción en castellano:
         Permite acceder a los atributos de la clase utilizando una sintaxis similar a un diccionario.
    ...
    def __repr__(self) -> str:
        """
        Descripción en castellano:
        Retorna una representación en forma de cadena de texto de la instancia de la clase. 
    ...
    def feh_ratio(self):
        """
        Descripción en castellano:
        Calcula la relación de metalicidad [Fe/H] a partir del valor Z (`metallicity_value`) 
        de la instancia y una constante solar (`Z_SUN`).
    ...
    def plot(self):
        ...
        Utiliza la clase `SpectralPlotter` para gestionar las funcionalidades de graficado.
    ...
    def get_all_properties(self) -> pd.DataFrame:
        ...
        *********************************************************************************
        ...
        Returns:
            pd.DataFrame: DataFrame with two columns: "Property" (property) and "Value" (value).
        """
        age = f"{self.age:.2e}"
