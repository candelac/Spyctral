...
class SpectralPlotter:
    ...
    *************************************************************************************
    ...
    def __call__(self, plot_kind="all_spectra", **kwargs):
        """
        Descripción en castellano:
        Permite utilizar la clase como una función para generar gráficos de diferentes tipos.
        Dependiendo del valor de `plot_kind`, se invoca un método específico para realizar
    ...
    def subplots(self, ax=None, **kwargs):
        ...
        Argumentos:
            ax (matplotlib.axes.Axes o None): Conjunto de ejes donde se graficarán los espectros.
        ...
        Retorna:
            numpy.ndarray: Arreglo con los ejes (`Axes`) correspondientes a los subgráficos.
        ...
        *********************************************************************************
        ...
        Arguments:
            ax (matplotlib.axes.Axes or None): Set of axes where the spectra will be plotted.
