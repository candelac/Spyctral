...
# No se si tendriamos que poner este max

MAX_VALUES_TO_REPR = 10

# Aca pongo algunas para empezar

DATA_FISA = "fisa"
DATA_STL = "starlight"

##
DATA_FISA_REDDENING = "reddening"
DATA_STL_V0_MIN = "v0_min"
DATA_STL_VD_MIN = "vd_min"
DATA_STL_AV_MIN = "AV_min"
DATA_STL_YAV_MIN = "YAV_min"
DATA_STL_AGE_J = "age_j"
DATA_STL_Z_J = "Z_j"
DATA_STL_MSTARS = "Mstars"
##

DATAS = (DATA_FISA, DATA_STL)
...
# Se crea una clase llamada ExtractorConf con los campos específicos
# de configuracion para la clase Extractor
...
# Esta es la clase de las clases Extractor -> metaclase
# va revisando si la clase no tiene los atributos y si estan vacios
...
# Esta es la clase base de la que van a heredar los extractors
...
class Extractor(metaclass=ExtractorMeta):
    ...
    def preprocess_arguments(self, **kwargs):
        ...
        """
        # create the bessel for the parameters. seria vessel?
        new_kwargs = {}
    ...
    # Este es el método que hay que definir en cada extractor
    # es donde pongo qué hace el extractor
    ...
    # Esto es un método que convierte los features a un dic de 1 dim
    # no entiendo bien que hace

    # Aqui deberia definir métodos que conecten la lectura de los
    # archivos con lo que necesitan los extractors
