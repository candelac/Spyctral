...
class Bunch(Mapping):
    ...
    *************************************************************************************
    ...
    def __getitem__(self, k):
        """
        Descripción en castellano:
        Permite acceder a los elementos almacenados en `_data` utilizando la sintaxis de indexación.
        ...
        Propósito:
            ...
            permite recuperar valores mediante `objeto[k]`, donde `objeto` es una instancia
            de `Bunch`.
        ...
        *************************************************************************************
        ...
        Purpose:
        This method enables dictionary-like indexing, allowing values to be retrieved using 
        `object[k]`, where `object` is an instance of `Bunch`.
